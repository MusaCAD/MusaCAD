...
- The manifest pins the `v0.5.0` tag (with its commit), which carries the GCC 15 fixes the
  KDE 6.11 runtime needs, the CMake install rules and the portal changes below.
